<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WF_Definiciones.aspx.cs" Inherits="Intranet.WorkflowStudio.WebForms.WF_Definiciones" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div class="form-inline mb-2">
                ...
                <asp:Button ID="btnLimpiar" runat="server" Text="Limpiar" CssClass="btn btn-sm btn-secondary" OnClick="btnLimpiar_Click" />
            </div>
            ...
            <asp:GridView ID="gvDef" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="160px">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkVerJson" runat="server" CommandName="VerJson" CommandArgument='<%# Eval("Id") %>' CssClass="btn btn-sm btn-info mr-1">JSON</asp:LinkButton>
                            <asp:LinkButton ID="lnkVerInst" runat="server" CommandName="VerInst" CommandArgument='<%# Eval("Id") %>' CssClass="btn btn-sm btn-secondary mr-1">Instancias</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
