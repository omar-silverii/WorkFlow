; (() => {
    ...
    register('util.logger', (node, ctx, dom) => {
        ...
        const inpMsg = el('input', 'input'); inpMsg.value = p.message || '';
        const sMsg = section('Message', inpMsg);
        ...
        bSave.onclick = () => {
            ...
            node.params = { level: selLevel.value, message: inpMsg.value || '' };
            ensurePosition(node);
        ...
        body.appendChild(sLevel); body.appendChild(sMsg);
