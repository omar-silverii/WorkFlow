...
namespace Intranet.WorkflowStudio.WebForms
{
    public partial class WorkflowUI : System.Web.UI.Page
    {
        ...
        private void GuardarDefinicionEnSql(string json)
        {
            ...
            string codigo = (esEmision ? "EMISION-" : "WF-") + DateTime.Now.ToString("yyyyMMdd-HHmmss");
            string nombre = (esEmision ? "Emisión de Póliza " : "Workflow desde UI ") + DateTime.Now.ToString("dd/MM/yyyy HH:mm");
            int version = 1;
