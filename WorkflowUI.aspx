...
<head runat="server">
  ...
  <meta charset="utf-8" />
   ...
   <link rel="stylesheet" href="Styles/workflow.ai.assistant.css?v=dev007-fix22" />
...
<body>
  <form id="form1" runat="server" ClientIDMode="Static">
   ...
   <main class="container-fluid px-3 px-md-4 py-0 wf-editor-main">
    ...
    <script src="Scripts/workflow.ai.assistant.js?v=dev007-fix22"></script>
    <!-- Inspectores -->
    ...
    <script src="Scripts/Inspectors/inspector.doc.attach.js?v=dev200"></script>
    <!-- (Opcional) Demos -->
